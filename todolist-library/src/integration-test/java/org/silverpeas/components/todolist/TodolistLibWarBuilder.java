 ...
 */
public class TodolistLibWarBuilder extends BasicCoreWarBuilder {
   ...
   */
  protected <T> TodolistLibWarBuilder(final Class<T> test) {
    super(test);
   ...
   */
  public static <T> TodolistLibWarBuilder onWarForTestClass(Class<T> test) {
    return new TodolistLibWarBuilder(test);
  }
