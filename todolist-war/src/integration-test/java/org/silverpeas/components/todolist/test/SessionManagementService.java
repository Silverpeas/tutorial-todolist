...
/**
 * A mock of the {@link SessionManagement} managed service in Silverpeas to ease the integration
 * tests. Its priority is set at a high value to ensure it replaces the default
 * {@link SessionManagement} implementation.
 */
@Service
@Singleton
@Default
