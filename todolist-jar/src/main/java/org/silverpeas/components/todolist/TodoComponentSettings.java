...
/**
 * The settings relative to the todolist component.
 */
public final class TodoComponentSettings {
  ...
  public static final String SETTINGS_PATH =
    "org.silverpeas.components.todolist.settings.TodoSettings";

  /**
   * The relative path of the i18n bundle of the Silverpeas component.
   */
  public static final String MESSAGES_PATH =
    "org.silverpeas.components.todolist.multilang.TodoBundle";
  ...
  public static final String ICONS_PATH =
    "org.silverpeas.components.todolist.settings.TodoIcons";
